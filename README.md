...
```bash
git clone --recurse-submodules git@github.com:arthurfenderbucker/openpi.git
...
# Install the policy-steering package (lightweight JAX guidance functions)
uv pip install -e ../../packages/policy_steering
```
